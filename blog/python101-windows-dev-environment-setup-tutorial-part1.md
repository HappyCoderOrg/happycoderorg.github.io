...
authors: happycoder
share_cover: /img/python101/python-logo.png
tags: 
    - 自學程式
    - 自學程式設計
    - 程式設計
...
<div class="video-container">
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/FQw0S7-WShE" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
</div>
