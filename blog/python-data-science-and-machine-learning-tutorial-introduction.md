...
![ 如何使用 Python 學習機器學習（Machine Learning）](/img/data-science101/intro/ai-history.png)
...
![ 如何使用 Python 學習機器學習（Machine Learning）](/img/data-science101/intro/ai-ml-dm.png)
...
![ 如何使用 Python 學習機器學習（Machine Learning）](/img/data-science101/intro/ai-plus.png)
