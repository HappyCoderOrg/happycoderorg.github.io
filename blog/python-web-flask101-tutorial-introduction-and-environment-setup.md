...
![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/python-logo.png) 
...
接下來我們將以 Anaconda 這個開發環境為主要講解環境。由於我們假定讀者已經有一些 Python 基礎，所以我們會跳過有關 Python 語法的基本較邵，若您對於 Python 入門基礎較不熟悉的話建議參考 [Python 101 快速入門教學](./python101-tutorial.md) ，此外我們也提供了 [Python Web 程式設計入門實戰線上課程](http://pics.ee/c34g) 可以參考。那就讓我們開始吧！

# 什麼是 Flask？

![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/flask-index.png) 
...
1. Microsoft VSCode 編輯器
    ...
    ![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/vscode-index.png) 

    我們可以安裝 Python 語法和格式檢查的相關 Python 套件幫助除錯：

    ![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/vscode-python.png) 
...
2. 終端機環境（iTterm/內建 terminal）
    ...
    ![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/iterm2.png) 

    下指令（$ 為提示字元，不用輸入）：

    ![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/iterm2-example.png) 
...
3. Git 版本控制系統/註冊 GitHub 帳戶 
    ...
    ![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/git-index.png) 

    互動式語法學習：

    ![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/try-git.png) 

    在介紹完 git 之後我們來了解一下 GitHub。GitHub 是一個可以存放 git 程式碼專案的平台，透過 GitHub 我們可以接觸到最新的開放原始碼資訊，也可以將我們的程式碼開源出來。
    
    ![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/github-index.png) 

    從 GitHub 上複製程式碼
    
    ![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/github-clone.png) 
...
4. Anaconda Python3 版本
    ...
    ![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/anaconda-index.png)

    選擇對應 Python 版本下載，我們使用 Graphical Installer（圖像介面安裝方式），接著在下載完成時按照預設的安裝方式完成安裝；
    ![Python Web Flask 實戰開發教學 - 簡介與環境建置](/img/flask101/anaconda-install.png) 
